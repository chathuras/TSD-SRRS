...
@section('content')
    ...
    <!-- div class="modal fade" id="resCalendar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true" style="width:90%; left: 30% !important;" -->
    <div class="modal fade" id="resCalendar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true" style="width:82%; left: 30% !important; top: 2%;">
