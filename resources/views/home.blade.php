    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            @section('js')
                ...
                {{--<script src="/js/dashboard/excanvas.min.js"></script>--}}
                {{--<script src="/js/dashboard/matrix.chat.js"></script>--}}
                {{--<script src="/js/dashboard/matrix.form_validation.js"></script>--}}
                {{--<script src="/js/dashboard/matrix.js"></script>--}}
                {{--<script src="/js/dashboard/matrix.tables.js"></script>--}}
                {{--<script src="/js/dashboard/matrix.dashboard.js"></script>--}}
                {{--<script src="/js/dashboard/matrix.interface.js"></script>--}}
